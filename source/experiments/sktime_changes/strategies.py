...
strategies.
"""
__all__ = ["TSCStrategy", "TSRStrategy", "TSCStrategy_proba"]
...
class TSCStrategy_proba(BaseSupervisedLearningStrategy):
    """
    ...
    def __init__(self, estimator, name=None):
        ...
        super(TSCStrategy_proba, self).__init__(estimator, name=name)
    
    def predict_proba(self, data):
        """
        Predict the probabilities using the given test data.
        ...
        y_proba : pandas.DataFrame
            Returns the dataframe of predicted values for each class.
        """

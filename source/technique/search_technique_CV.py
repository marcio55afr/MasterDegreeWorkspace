...
class SearchTechniqueCV(BaseClassifier):
    ...
    def __init__(self,
        ...
        # if (word_selection != 'p threshold') and (word_selection != 'best n words'): raise ValueError('word_selection
        # must be a valid method of selection, as "p threshold" or "best n words"')
